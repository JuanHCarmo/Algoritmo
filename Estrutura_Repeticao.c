...
int main() {
    ...
    testar_int("6. fibonacci", fibonacci(7), 13, "n=7 (1,1,2,3,5,8,13)");
    ...
    printf("10. cont_regress (Visualizacao dos numeros abaixo):\n");
    testar_int("10. cont_regress (Retorno)", contagem_regressiva(3), 4, "n=3 (3,2,1,0)");
